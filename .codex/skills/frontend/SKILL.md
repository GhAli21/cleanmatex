...
- **Adding a new page** that should appear in the sidebar
...
6. If permissions are new, also follow the permission-migration rule (every new permission code needs a DB migration, not TS-only).
