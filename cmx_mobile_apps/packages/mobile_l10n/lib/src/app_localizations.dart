...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      'booking.step2.perPieceTitle': 'Set preferences per piece',
      'booking.step2.pieceLabel': 'Piece {n}',
      'booking.step2.servicePrefsSection': 'Service preferences',
      'booking.step2.packingSection': 'Packing',
      'booking.step2.colorSection': 'Color',
      'booking.step2.notesHint': 'Notes (optional)',
      'booking.step2.emptyCart': 'Your cart is empty',
    ...
    'ar': {
      ...
      'booking.step2.perPieceTitle': 'تعيين التفضيلات لكل قطعة',
      'booking.step2.pieceLabel': 'قطعة {n}',
      'booking.step2.servicePrefsSection': 'تفضيلات الخدمة',
      'booking.step2.packingSection': 'التغليف',
      'booking.step2.colorSection': 'اللون',
      'booking.step2.notesHint': 'ملاحظات (اختياري)',
      'booking.step2.emptyCart': 'سلتك فارغة',
