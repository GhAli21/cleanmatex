---
name: add-setting-db
description: add-setting-db workflow for CleanMateX Tenant App. Use only when explicitly working on add-setting-db-related tasks.
user-invocable: true
version: 1.1.0
deprecated: false
effort: low
references:
  - @.claude/skills/add-setting-db/reference-original.md
  - CLAUDE.md
agents:
---
...
Use this skill only when the task explicitly matches **add-setting-db**. Keep the active prompt small; read `reference-original.md` only when deeper examples or edge cases are required.
