---
name: "source-command-create-ui-screen-in-sys-tree"
description: "Migrated source command `create-ui-screen-in-sys-tree`"
---

# source-command-create-ui-screen-in-sys-tree

Use this skill when the user asks to run the migrated source command `create-ui-screen-in-sys-tree`.
