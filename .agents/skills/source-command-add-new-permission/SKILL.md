---
name: "source-command-add-new-permission"
description: "Migrated source command `add-new-permission`"
---

# source-command-add-new-permission

Use this skill when the user asks to run the migrated source command `add-new-permission`.
