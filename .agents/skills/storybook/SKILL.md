---
name: storybook
description: storybook workflow for CleanMateX Tenant App. Use only when explicitly working on storybook-related tasks.
user-invocable: true
version: 1.1.0
deprecated: false
effort: low
references:
  - @.claude/skills/storybook/reference-original.md
  - CLAUDE.md
agents:
---
...
Use this skill only when the task explicitly matches **storybook**. Keep the active prompt small; read `reference-original.md` only when deeper examples or edge cases are required.
