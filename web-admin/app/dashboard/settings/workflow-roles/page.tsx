...
import { SETTINGS_WORKFLOW_ROLES_ACCESS } from '@features/settings/access/settings-access'
...
export default function WorkflowRolesPage() {
  ...
  if (loading) {
    return (
      <RequireAnyPermission permissions={SETTINGS_WORKFLOW_ROLES_ACCESS.page.permissions ?? []}>
