    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-wrap items-center gap-4">
        <Link
          href={
            returnToInvoiceId
              ? `/dashboard/internal_fin/invoices/${returnToInvoiceId}`
            ...
            <dl className="space-y-3 text-sm">
              ...
              {payment.invoiceNumber && (
                <div className="flex items-center justify-between">
                  ...
                  <dd>
                    <Link
                      href={`/dashboard/internal_fin/invoices/${payment.invoice_id}`}
                      className="text-blue-600 hover:text-blue-800"
                    >
                      {payment.invoiceNumber}
                    </Link>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            ...
            <div className="space-y-3">
              ...
              {payment.status === 'completed' && payment.paid_amount > 0 && (
                <Link
                  href={`/dashboard/internal_fin/payments/${payment.id}/print/receipt-voucher`}
                  target="_blank"
