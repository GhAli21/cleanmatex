      ...
      content: (
        <OrdersEditHistoryTabRprt
          ...
          translations={{
            ...
            preferenceChanges: t.preferenceChanges ?? tFull('editHistory.preferenceChanges'),
            preferenceAdded: t.preferenceAdded ?? tFull('editHistory.preferenceAdded'),
            preferenceRemoved: t.preferenceRemoved ?? tFull('editHistory.preferenceRemoved'),
            preferenceModified: t.preferenceModified ?? tFull('editHistory.preferenceModified'),
            extraPrice: t.extraPrice ?? tFull('editHistory.extraPrice'),
            preferenceCode: t.preferenceCode ?? tFull('editHistory.preferenceCode'),
            preferenceKind: t.preferenceKind ?? tFull('editHistory.preferenceKind'),
            preferenceContent: t.preferenceContent ?? tFull('editHistory.preferenceContent'),
            preferenceLevel: t.preferenceLevel ?? tFull('editHistory.preferenceLevel'),
            pieceChanges: t.pieceChanges ?? tFull('editHistory.pieceChanges'),
            pieceAdded: t.pieceAdded ?? tFull('editHistory.pieceAdded'),
            pieceRemoved: t.pieceRemoved ?? tFull('editHistory.pieceRemoved'),
            pieceModified: t.pieceModified ?? tFull('editHistory.pieceModified'),
            pieceColor: t.pieceColor ?? tFull('editHistory.pieceColor'),
            pieceBrand: t.pieceBrand ?? tFull('editHistory.pieceBrand'),
            pieceRack: t.pieceRack ?? tFull('editHistory.pieceRack'),
            packingPref: t.packingPref ?? tFull('editHistory.packingPref'),
