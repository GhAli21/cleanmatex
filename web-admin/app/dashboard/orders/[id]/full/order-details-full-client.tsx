...
export function OrderDetailsFullClient({
  ...
  const editHistoryTranslations = {
    ...
    preferenceChanges: t.preferenceChanges ?? 'Preference Changes',
    preferenceAdded: t.preferenceAdded ?? 'Added',
    preferenceRemoved: t.preferenceRemoved ?? 'Removed',
    preferenceModified: t.preferenceModified ?? 'Modified',
    extraPrice: t.extraPrice ?? 'Extra price',
    preferenceCode: t.preferenceCode ?? 'Preference code',
    preferenceKind: t.preferenceKind ?? 'Kind',
    preferenceContent: t.preferenceContent ?? 'Preference content',
    preferenceLevel: t.preferenceLevel ?? 'Level',
    pieceChanges: t.pieceChanges ?? 'Piece Changes',
    pieceAdded: t.pieceAdded ?? 'Added',
    pieceRemoved: t.pieceRemoved ?? 'Removed',
    pieceModified: t.pieceModified ?? 'Modified',
    pieceColor: t.pieceColor ?? 'Color',
    pieceBrand: t.pieceBrand ?? 'Brand',
    pieceRack: t.pieceRack ?? 'Rack',
    packingPref: t.packingPref ?? 'Packing',
