 ...
 *
 * Why:
 * Exposes the canonical plural refund initiation endpoint under the B01
 * contract: mandatory idempotency key + reason context, service-derived
 * source classification, live RBAC, and manual-exception safeguards.
 *
 * @param request incoming authenticated request
 * @param root0 route params wrapper containing the target order identifier
 * @param root0.params route params promise containing the target order identifier
