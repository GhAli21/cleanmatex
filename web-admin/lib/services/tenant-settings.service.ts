...
export const SETTING_CODES = {
  ...
  ERP_LITE_FISCAL_YEAR_START: 'ERP_LITE_FISCAL_YEAR_START',
  ERP_LITE_FIRST_PERIOD_START: 'ERP_LITE_FIRST_PERIOD_START',
  ERP_LITE_PERIOD_CLOSE_ENABLED: 'ERP_LITE_PERIOD_CLOSE_ENABLED',
} as const;
