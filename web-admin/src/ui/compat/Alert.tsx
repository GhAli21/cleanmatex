 ...
 * For displaying messages (success, error, warning, info)
 */
      ...
      <div className="flex">
        ...
        {onClose && (
          <div className="ml-auto pl-3">
            <button
              onClick={onClose}
              className={`inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 ${classes.icon} hover:bg-opacity-20`}
            >
...
// AlertDescription component for structured alert content
