  ...
  },
  {
    ...
    apiDependencies: [
      ...
      },
      {
        ...
        method: 'POST',
        path: '/tenant-api/tenants/[tenantId]/users/[userId]/deactivate',
        notes: ['Platform API via rbacFetch.'],
      },
      {
        label: 'Activate user',
        method: 'POST',
        path: '/tenant-api/tenants/[tenantId]/users/[userId]/activate',
        notes: ['Platform API via rbacFetch.'],
      },
      {
        label: 'Create user',
        method: 'POST',
        path: '/tenant-api/tenants/[tenantId]/users',
        notes: ['Invite flow uses createUser with server-generated password; platform may send email separately.'],
      },
    ],
    notes: SETTINGS_NOTES,
  },
