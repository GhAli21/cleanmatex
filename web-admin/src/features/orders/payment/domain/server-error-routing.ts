...
const SERVER_ERROR_TO_CAPABILITY: Record<string, PaymentCapabilityKey> = {
  ...
  CASH_DRAWER_REQUIRED: PAYMENT_CAPABILITY.CASH_DRAWER,
  CASH_DRAWER_SESSION_NOT_OPEN: PAYMENT_CAPABILITY.CASH_DRAWER,
  DRAWER_SESSION_CLOSING: PAYMENT_CAPABILITY.CASH_DRAWER,
