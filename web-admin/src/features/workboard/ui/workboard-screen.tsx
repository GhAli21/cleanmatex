    ...
    <div className="mx-auto w-full max-w-[1440px] space-y-6 p-4 md:p-6">
      ...
      <CmxCard>
        ...
        <CmxCardContent className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          <CmxInput value={search} onChange={(event) => { setSearch(event.target.value); resetPage() }} placeholder={t('filters.search')} aria-label={t('filters.search')} startIcon={<Search className="h-4 w-4" />} />
