...
**Document ID**: 007_catalog_service_management_dev_prd  
**Version**: 1.0  
**Status**: Ready  
...
- Added `org_price_lists_mst` and `org_price_list_items_dtl` with RLS and helper function `get_product_price()`.
- Implemented Next.js API routes for categories, products, pricing, import/export.
- Built admin UI pages for categories, services (list/new/edit), pricing, and CSV modals.
- Seeded demo price lists and items for demo tenants.
