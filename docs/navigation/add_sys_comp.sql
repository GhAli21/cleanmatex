...
VALUES ('orders_packing', 'orders', 'Orders Packing', 'ØªØ¹Ø¨Ø¦Ø© Ø§Ù„Ø·Ù„Ø¨Ø§Øª', NULL, NULL, 1, '/dashboard/packing', NULL, 'orders:read', NULL, NULL, NULL, 10, false, true, true, true, true, '["''super_admin''", "''tenant_admin''", "''admin''", "''operator''"]', '[]', false, '[]', '{}', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Boxes', NULL, NULL, NULL, 1, '2026-01-15 21:30:00.658385', 'SYSTEM_USER', NULL, '2026-01-15 21:30:53.244', 'SYSTEM_USER', NULL) ;

INSERT INTO public.sys_components_cd (comp_code, parent_comp_code, label, label2, description, description2, comp_level, comp_path, feature_code, main_permission_code, role_code, screen_code, badge, display_order, is_leaf, is_navigable, is_active, is_system, is_for_tenant_use, roles, permissions, require_all_permissions, feature_flag, metadata, comp_value1, comp_value2, comp_value3, comp_value4, comp_value5, color1, color2, color3, comp_icon, comp_image, rec_order, rec_notes, rec_status, created_at, created_by, created_info, updated_at, updated_by, updated_info) 
VALUES ('orders_delivery', 'orders', 'Orders Delivery', 'ØªØ³Ù„ÙŠÙ… Ø§Ù„Ø·Ù„Ø¨Ø§Øª', NULL, NULL, 1, '/dashboard/delivery', NULL, 'orders:read', NULL, NULL, NULL, 11, false, true, true, true, true, '[]', '[]', false, '[]', '{}', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Truck', NULL, NULL, NULL, 1, '2026-01-15 21:32:12.263608', 'SYSTEM_USER', NULL, NULL, NULL, NULL) ;
...
INSERT INTO sys_components_cd (
  ...
  'ØªÙƒÙˆÙŠÙ† Ø§Ù„Ø¥Ø¹Ø¯Ø§Ø¯Ø§Øª Ø§Ù„Ù…Ø§Ù„ÙŠØ© Ø¨Ù…Ø§ ÙÙŠ Ø°Ù„Ùƒ Ù…Ø¹Ø¯Ù„Ø§Øª Ø§Ù„Ø¶Ø±Ø§Ø¦Ø¨ ÙˆØ£Ù†ÙˆØ§Ø¹ Ø§Ù„Ø¶Ø±Ø§Ø¦Ø¨',
...
INSERT INTO sys_components_cd (
  ...
  'catalog_pricing',
  'Price List Details',
  'ØªÙØ§ØµÙŠÙ„ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ø£Ø³Ø¹Ø§Ø±',
  'View and edit price list details, items, and history',
  'Ø¹Ø±Ø¶ ÙˆØªØ¹Ø¯ÙŠÙ„ ØªÙØ§ØµÙŠÙ„ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ø£Ø³Ø¹Ø§Ø± ÙˆØ§Ù„Ø¹Ù†Ø§ØµØ± ÙˆØ§Ù„ØªØ§Ø±ÙŠØ®',
...
SET 
  label2 = 'Ø§Ù„ØªØ³Ø¹ÙŠØ±',
  description = 'Manage price lists, product pricing, and quantity tiers',
  description2 = 'Ø¥Ø¯Ø§Ø±Ø© Ù‚ÙˆØ§Ø¦Ù… Ø§Ù„Ø£Ø³Ø¹Ø§Ø± ÙˆØ£Ø³Ø¹Ø§Ø± Ø§Ù„Ù…Ù†ØªØ¬Ø§Øª ÙˆÙ…Ø³ØªÙˆÙŠØ§Øª Ø§Ù„ÙƒÙ…ÙŠØ©',
...
INSERT INTO sys_components_cd (
  ...
  'Ø¹Ø±Ø¶ ÙˆØ¥Ø¯Ø§Ø±Ø© ÙÙˆØ§ØªÙŠØ± Ø§Ù„Ø¹Ù…Ù„Ø§Ø¡ ÙˆØ§Ù„Ø£Ø±ØµØ¯Ø© Ø§Ù„Ù…ØªØ¨Ù‚ÙŠØ©',
  '/dashboard/invoices',
  'Receipt',
  1,
  0,
...
INSERT INTO sys_components_cd (
  ...
  'Ø¥Ù†Ø´Ø§Ø¡ Ø¯ÙØ¹Ø© Ù…Ø³ØªÙ‚Ù„Ø© Ø¬Ø¯ÙŠØ¯Ø© (ÙØ§ØªÙˆØ±Ø©ØŒ Ø¹Ø±Ø¨ÙˆÙ†ØŒ Ø¯ÙØ¹Ø© Ù…Ø³Ø¨Ù‚Ø©ØŒ Ø£Ùˆ Ù†Ù‚Ø·Ø© Ø¨ÙŠØ¹)',
  '/dashboard/internal_fin/payments/new',
  'Plus',
  2,
  0,
  true,
...
INSERT INTO sys_components_cd (
  ...
  'Ø¹Ø±Ø¶ ØªÙØ§ØµÙŠÙ„ Ø§Ù„Ø¯ÙØ¹Ø© ÙˆØ§Ù„Ù…Ù„Ø§Ø­Ø¸Ø§Øª ÙˆØ§Ù„Ø¥Ù„ØºØ§Ø¡ Ø£Ùˆ Ø§Ù„Ø§Ø³ØªØ±Ø¯Ø§Ø¯',
  '/dashboard/internal_fin/payments/[id]',
  'FileText',
  2,
  1,
  true,
...
UPDATE sys_components_cd
SET
  label2 = 'Ø§Ù„ØªÙ‚Ø§Ø±ÙŠØ± ÙˆØ§Ù„ØªØ­Ù„ÙŠÙ„Ø§Øª',
  description = 'Reports and analytics for orders, payments, invoices, revenue, and customers',
  description2 = 'Ø§Ù„ØªÙ‚Ø§Ø±ÙŠØ± ÙˆØ§Ù„ØªØ­Ù„ÙŠÙ„Ø§Øª Ù„Ù„Ø·Ù„Ø¨Ø§Øª ÙˆØ§Ù„Ù…Ø¯ÙÙˆØ¹Ø§Øª ÙˆØ§Ù„ÙÙˆØ§ØªÙŠØ± ÙˆØ§Ù„Ø¥ÙŠØ±Ø§Ø¯Ø§Øª ÙˆØ§Ù„Ø¹Ù…Ù„Ø§Ø¡',
  is_leaf = false,
  updated_at = CURRENT_TIMESTAMP
...
INSERT INTO sys_components_cd (
  ...
  (
    ...
    'ØªÙ‚Ø§Ø±ÙŠØ± Ø§Ù„Ø·Ù„Ø¨Ø§Øª ÙˆØ§Ù„Ù…Ø¨ÙŠØ¹Ø§Øª',
  ...
  (
    ...
    'Ø§Ù„Ù…Ø¯ÙÙˆØ¹Ø§Øª',
    'Payments reports',
    'ØªÙ‚Ø§Ø±ÙŠØ± Ø§Ù„Ù…Ø¯ÙÙˆØ¹Ø§Øª',
...
INSERT INTO sys_components_cd (
  ...
  'billing',
  'Receipt Vouchers',
  'Ø¥ÙŠØµØ§Ù„Ø§Øª Ø§Ù„Ø¯ÙØ¹',
  'View and manage receipt vouchers',
  'Ø¹Ø±Ø¶ ÙˆØ¥Ø¯Ø§Ø±Ø© Ø¥ÙŠØµØ§Ù„Ø§Øª Ø§Ù„Ø¯ÙØ¹',
...
UPDATE sys_components_cd
SET
  label2 = 'Ø§Ù„Ù…Ø®Ø²ÙˆÙ† ÙˆØ§Ù„Ø¢Ù„Ø§Øª',
  description = 'Manage inventory stock and machines',
  description2 = 'Ø¥Ø¯Ø§Ø±Ø© Ù…Ø®Ø²ÙˆÙ† Ø§Ù„Ù…ÙˆØ§Ø¯ ÙˆØ§Ù„Ø¢Ù„Ø§Øª',
  comp_icon = 'Boxes',
  is_leaf = false,
...
INSERT INTO sys_components_cd (
  ...
  'Ø¥Ø¯Ø§Ø±Ø© Ù…Ø³ØªÙˆÙŠØ§Øª Ø§Ù„Ù…Ø®Ø²ÙˆÙ† ÙˆØ§Ù„ØªØ¹Ø¯ÙŠÙ„Ø§Øª',
...
INSERT INTO sys_components_cd (
  ...
  'Ø¥Ø¯Ø§Ø±Ø© Ø§Ù„Ø¢Ù„Ø§Øª ÙˆØ§Ù„Ù…Ø¹Ø¯Ø§Øª',
...
INSERT INTO sys_components_cd (
  ...
  'Ø¥Ø¯Ø§Ø±Ø© Ø§Ù„ØªÙˆØµÙŠÙ„ ÙˆØªØªØ¨Ø¹Ù‡',
  '/dashboard/delivery',
  'Truck',
  0,
  4,
...
INSERT INTO sys_components_cd (
  ...
  'Ø¥Ø¯Ø§Ø±Ø© Ø£Ø¹Ø¶Ø§Ø¡ Ø§Ù„ÙØ±ÙŠÙ‚ ÙˆØ§Ù„ÙˆØµÙˆÙ„',
  '/dashboard/users',
  'Users',
  0,
  5,
...
INSERT INTO sys_components_cd (
  ...
  'Ø¹Ø±Ø¶ ÙˆØ¥Ø¯Ø§Ø±Ø© Ø¬Ù…ÙŠØ¹ Ø£Ø¹Ø¶Ø§Ø¡ Ø§Ù„ÙØ±ÙŠÙ‚',
  '/dashboard/users',
  'Users',
  1,
  0,
...
INSERT INTO sys_components_cd (
  ...
  'Ø¥Ø¯Ø§Ø±Ø© Ø§Ù„ØµÙ„Ø§Ø­ÙŠØ§Øª Ø§Ù„ØªÙØµÙŠÙ„ÙŠØ© ÙˆØ§Ù„ØªØ­ÙƒÙ… ÙÙŠ Ø§Ù„ÙˆØµÙˆÙ„',
...
INSERT INTO sys_components_cd (
  ...
  'Ø¹Ø±Ø¶ Ø¬Ù…ÙŠØ¹ Ø¥Ø¹Ø¯Ø§Ø¯Ø§Øª Ø§Ù„Ù…Ø³ØªØ£Ø¬Ø± ÙˆØ§Ù„ÙØ±ÙˆØ¹ ÙˆØ§Ù„Ù…Ø³ØªØ®Ø¯Ù…ÙŠÙ† ÙˆØ§Ù„ØªÙƒÙˆÙŠÙ†Ø§Øª Ø°Ø§Øª Ø§Ù„ØµÙ„Ø© ÙÙŠ Ø´Ø§Ø´Ø© Ù…ÙˆØ­Ø¯Ø© ÙˆØ§Ø­Ø¯Ø©',
  '/dashboard/settings/allsettings',
  'SlidersHorizontal',
  1,
  0,
  true,
...
-- =====================================================
-- 14. Catalog Preferences (child of catalog)
-- =====================================================
-- Add Preferences page under Catalog parent
...
INSERT INTO sys_components_cd (
  ...
  'Ø¥Ø¯Ø§Ø±Ø© ÙƒØªØ§Ù„ÙˆØ¬ ØªÙØ¶ÙŠÙ„Ø§Øª Ø§Ù„Ø®Ø¯Ù…Ø© ÙˆØ§Ù„Ø­Ø²Ù…',
...
-- =====================================================
-- 15. Catalog Customer Categories (child of catalog)
-- =====================================================
-- Add Customer Categories page under Catalog parent
...
INSERT INTO sys_components_cd (
  ...
  'catalog',
  'Customer Categories',
  'ÙØ¦Ø§Øª Ø§Ù„Ø¹Ù…Ù„Ø§Ø¡',
  'Manage tenant customer categories (org_customer_category_cf)',
  'Ø¥Ø¯Ø§Ø±Ø© ÙØ¦Ø§Øª Ø§Ù„Ø¹Ù…Ù„Ø§Ø¡ Ù„Ù„Ù…Ø³ØªØ£Ø¬Ø± (org_customer_category_cf)',
