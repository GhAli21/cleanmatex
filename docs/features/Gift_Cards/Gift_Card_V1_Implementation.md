...
| `src/features/orders/ui/payment-modal-enhanced-02.tsx` | Modified | Added VOIDED error code to resolveGiftCardError switch |
| `app/dashboard/orders/[id]/full/order-details-full-client.tsx` | Modified | Gift card removed from discounts zone; shown only in Settlements zone |
| `src/features/orders/ui/order-invoices-payments-print-rprt.tsx` | Modified | Gift card in distinct Settlements subsection with purple styling |
