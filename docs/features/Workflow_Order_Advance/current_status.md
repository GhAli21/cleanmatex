...
| Version | [version.txt](version.txt) → `0.3.8-p4-public-tracking-ux` |
...
| Next (you) | Smoke public confirm-received after `0437` (verify disabled state + pay-on-collection notice); smoke cancel/hold/stop |
