...
| Artifact | Role |
|----------|------|
| Tenant `.cursor/plans/workflow_live_profile_runtime_20260827.plan.md` | Platform runtime cutover (Gates 0–5). Gate 5 **done**. Tenant docs-final **done 2026-09-12**. Residual: soak. |
| HQ `.cursor/plans/workflow_live_profile_runtime_20260827.plan.md` | Studio / Check policy. Gate 5 `/compile` retirement **done**. HQ docs-final **done**. Residual: soak. |
| **This document** | **Product capability programme** that assumes ADR-0010 live rows are already the authority |

Do **not** treat this plan as a rewrite or supersession of the 20260827 pair. Gate 4 Studio chrome and Gate 5 `/compile` retirement are **done**. Residual on those plans: soak, HQ/tenant docs-final, operator smokes. Implement create presets / collection / hold WPs here without reopening “artifact vs live rows.”
