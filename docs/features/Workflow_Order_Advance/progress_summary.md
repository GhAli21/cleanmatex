...
- [ ] Establish stage-owned services/APIs so Processing, Quality, Packing, Ready/Release, Pickup, and remaining Delivery writers do not rely on screen-local workflow writers
