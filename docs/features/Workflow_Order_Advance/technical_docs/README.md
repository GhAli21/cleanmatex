# Technical Docs — Workflow Order Advance

## Available notes

- [public_tracking_token_rollout.md](public_tracking_token_rollout.md) — implementation details for opaque customer links and confirm-received compatibility
- [rpc_retirement.md](rpc_retirement.md) — engine-only cutover boundary, migration `0442`, and rollback policy
