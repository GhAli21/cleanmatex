...
- [ ] T01–T18 pass on pilot tenants (T03, T05–T18 closed with real automated tests as of 2026-09-11 — see `12_Test_Plan.md`; T01/T02/T04 remain partial; T15's CI-gate half closed, its DB-integration graph-validator half still not wired into CI)
