...
create table if not exists public.org_gift_cards_mst (
  ...
  redeemed_amount numeric(19,4) not null default 0,
  bonus_amount numeric(19,4) not null default 0,
  bonus_remaining numeric(19,4) not null default 0,
  issue_date date,
...
create table if not exists public.org_gift_card_txn_dtl (
  ...
  amount numeric(19,4) not null default 0,
  balance_before numeric(19,4) not null default 0,
...
create table if not exists public.org_loyalty_accounts_mst (
  ...
  monetary_balance numeric(19,4) not null default 0,
  lifetime_points_earned numeric(19,4) not null default 0,
  lifetime_points_redeemed numeric(19,4) not null default 0,
  lifetime_points_expired numeric(19,4) not null default 0,
...
create table if not exists public.org_loyalty_txn_dtl (
  ...
  customer_id uuid not null,
  txn_type varchar(50) not null,
  points_amount numeric(19,4) not null default 0,
  monetary_amount numeric(19,4) not null default 0,
...
create table if not exists public.org_promotions_mst (
  ...
  used_budget_amount numeric(19,4) not null default 0,
  usage_limit integer,
...
create table if not exists public.org_promotion_rewards_dtl (
  ...
  max_reward_amount numeric(19,4),
  rec_status smallint not null default 1,
  created_at timestamp with time zone not null default now()
);
...
begin
  if to_regclass('public.org_orders_mst') is not null then
    alter table public.org_orders_mst
      add column if not exists items_gross_amount numeric(19,4) default 0,
      add column if not exists services_gross_amount numeric(19,4) default 0,
      add column if not exists gross_amount numeric(19,4) default 0,
      add column if not exists preference_charges_amount numeric(19,4) default 0,
      add column if not exists other_charges_amount numeric(19,4) default 0,
      add column if not exists total_charges_amount numeric(19,4) default 0,
      add column if not exists auto_discount_amount numeric(19,4) default 0,
      add column if not exists manual_discount_amount numeric(19,4) default 0,
      add column if not exists promotion_discount_amount numeric(19,4) default 0,
      add column if not exists coupon_discount_amount numeric(19,4) default 0,
      add column if not exists loyalty_discount_amount numeric(19,4) default 0,
      add column if not exists total_discount_amount numeric(19,4) default 0,
      add column if not exists net_before_tax_amount numeric(19,4) default 0,
      add column if not exists vat_amount numeric(19,4) default 0,
      add column if not exists other_tax_amount numeric(19,4) default 0,
      add column if not exists total_tax_amount numeric(19,4) default 0,
      add column if not exists grand_total_amount numeric(19,4) default 0,
      add column if not exists gift_card_applied_amount numeric(19,4) default 0,
      add column if not exists wallet_applied_amount numeric(19,4) default 0,
      add column if not exists advance_applied_amount numeric(19,4) default 0,
      add column if not exists customer_credit_applied_amount numeric(19,4) default 0,
      add column if not exists loyalty_credit_applied_amount numeric(19,4) default 0,
      add column if not exists total_credit_applied_amount numeric(19,4) default 0,
      add column if not exists net_receivable_amount numeric(19,4) default 0,
      add column if not exists cash_paid_amount numeric(19,4) default 0,
      add column if not exists card_paid_amount numeric(19,4) default 0,
      add column if not exists check_paid_amount numeric(19,4) default 0,
      add column if not exists bank_transfer_paid_amount numeric(19,4) default 0,
      add column if not exists payment_gateway_paid_amount numeric(19,4) default 0,
      add column if not exists total_paid_amount numeric(19,4) default 0,
      add column if not exists invoice_ar_amount numeric(19,4) default 0,
      add column if not exists pay_on_collection_amount numeric(19,4) default 0,
      add column if not exists rounding_adjustment_amount numeric(19,4) default 0,
      add column if not exists change_returned_amount numeric(19,4) default 0,
      add column if not exists outstanding_amount numeric(19,4) default 0,
