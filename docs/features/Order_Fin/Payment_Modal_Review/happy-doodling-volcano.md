...
- [ ] Phase 2G — engine + Full-view split — **decomposed spec ready:** `payment-modal-v4-phase-2G-engine-view-split-EXECUTION-SPEC.md` (2G-1 engine compose + wire needsAdvanced → 2G-2 view split + thin shell; each independently green; 2G-2 needs full manual QA since the oracle is payload-only)
