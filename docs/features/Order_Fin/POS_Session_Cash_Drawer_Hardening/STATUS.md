...
**Program status:** Wave 0 (Foundation) **COMPLETE** — all migrations (0515–0518) applied local+remote. Wave A **IN PROGRESS** — A1 (session numbering, migration `0519` applied) and A2 (drawer-scope locking) done; A3-1/A3-2/A3-3 done; A4-1/A4-2 done. Remaining: A3-4/5/6b/7, A4-3/3b/3c/3d/4, A5 (exit gates), A6 (cash tender rounding).
...
| A | Money & concurrency integrity | **IN PROGRESS** (A1 **COMPLETE**; A2 **COMPLETE** except the documented payment-during-close gap — D22; A3 **PARTIAL** — A3-1/A3-2/A3-3 done (D23, D24), A3-4/A3-5/A3-6/A3-6b/A3-7 not done; A4/A6 not started) | 0519 (session numbering); A2/A3 needed no migration | **APPLIED** (local + remote) 2026-09-23 |
...
| A3-4 | ⬜ Not done | Money-as-strings API contract — not started |
| A3-5 | ⬜ Not done | 500-payment regression test — not started |
| A3-6 | 🟡 Checked, not yet triggered | Close-preview test still passes (different function); will need updating once A3-2 lands. `b15-currency-tolerance-guard.test.ts` updated deliberately for A3-3. Full sweep: 94/94 passing |
| A3-6b | ⬜ Not done | Demo-data recompute — not needed yet (A3-1 only changes future closes) |
| A3-7 | ⬜ Not done | Reconciliation-report consistency check — deferred with A3-2/A3-4 |
...
| A5 | ⬜ Not started | Wave A exit gates |
