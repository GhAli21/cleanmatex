...
| 3 | Capability dialogs (domain-level) | 🟡 IN PROGRESS — 3a facade ext ✅ (`e80f9258`) · split-tender ✅ (`5297a7f3`) · cash-drawer selector ✅ (`277e8778`) · gift-card(+PIN) ✅ · promo ✅ · customer-credit ✅ · B2B account-billing ✅ · overpayment-wrap ✅ · FX line ✅ · PAY_LATER ⬜ · registry Dialog wiring ⬜ | split 4/4 · drawer 3/3 · gift-card 6/6 · promo 5/5 · customer-credit 6/6 · b2b 5/5 · overpayment 5/5 · fx 5/5 · facade 2/2 · module 197/197 · i18n ✓ · eslint 0 · tsc 0 |
...
- **Remaining (build one per commit):** PAY_LATER (outstanding-policy selector NONE/PAY_ON_COLLECTION/CREDIT_INVOICE; action `changeOutstandingPolicy`). Then registry `Dialog`/presentation wiring.
