...
| 3 | Capability dialogs (domain-level) | 🟡 IN PROGRESS — all capability surfaces ✅ (3a facade `e80f9258` · split `5297a7f3` · drawer `277e8778` · gift-card · promo · customer-credit · B2B · overpayment-wrap · FX line · PAY_LATER); **remaining: registry `Dialog`/presentation wiring** ⬜ | split 4/4 · drawer 3/3 · gift-card 6/6 · promo 5/5 · customer-credit 6/6 · b2b 5/5 · overpayment 5/5 · fx 5/5 · pay-later 4/4 · facade 2/2 · module 201/201 · i18n ✓ · eslint 0 · tsc 0 |
...
- **Remaining Phase-3 step:** registry `Dialog`/presentation wiring — map each `PaymentCapabilityKey` → its dialog/line component so the Phase-4/5 renderer can mount capabilities uniformly from `evaluateCapabilities`.
