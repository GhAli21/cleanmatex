...
| 3 | Capability dialogs (domain-level) | 🟡 IN PROGRESS — 3a facade ext ✅ (`e80f9258`) · split-tender ✅ (`5297a7f3`) · cash-drawer selector ✅ (`277e8778`) · gift-card(+PIN) ✅ · promo ✅ · customer-credit ✅ · B2B account-billing ✅ · overpayment-wrap ✅ · FX/PAY_LATER ⬜ | split 4/4 · drawer 3/3 · gift-card 6/6 · promo 5/5 · customer-credit 6/6 · b2b 5/5 · overpayment 5/5 · facade 2/2 · module 192/192 · i18n ✓ · eslint 0 · tsc 0 |
...
- **Remaining dialogs (build one per commit, each extends i18n + tests):** FX/rounding inline line (`FX_ROUNDING`, read-only, presentation=**inline** not a dialog), PAY_LATER (outstanding-policy selector; action `changeOutstandingPolicy`). Then registry `Dialog` wiring.
