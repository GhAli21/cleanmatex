...
taxAmount        = afterDiscounts × taxRate          (VAT/GST tax-profile lines)
additionalTax    = sum of CUSTOM-type tax-profile lines (0 when no profile applies)
grandTotal       = afterDiscounts + taxAmount + additionalTax + chargesTotal
