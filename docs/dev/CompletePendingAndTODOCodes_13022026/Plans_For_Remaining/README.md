...
|---|------|------|----------|--------|
| 01 | [01_piece_history.md](01_piece_history.md) | Piece history (audit trail) | High | Pending |
...
| 07 | [07_dashboard_widgets.md](07_dashboard_widgets.md) | PaymentMix, Turnaround, Issues, DriverUtilization, DeliveryRate, Alerts | High | Pending |
| 08 | [08_settings_pages.md](08_settings_pages.md) | General & Branding settings API wiring | High | ✅ Done (2026-05-07) |
| 09 | [09_users_page.md](09_users_page.md) | Users/Team management API | High | Pending — note: `lib/api/users.ts:498` `resetUserPassword` returns explicit "not supported via this API client" |
