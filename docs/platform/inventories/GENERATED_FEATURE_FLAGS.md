...
| advanced_analytics | navigation | config/navigation.ts | 519 | //featureFlag: FLAG_KEYS.ADVANCED_ANALYTICS, |
...
| campaigns_enabled | navigation | config/navigation.ts | 777 | featureFlag: FLAG_KEYS.CAMPAIGNS_ENABLED, |
...
| erp_lite_ap_enabled | navigation | config/navigation.ts | 681 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_AP_ENABLED, |
| erp_lite_ar_enabled | navigation | config/navigation.ts | 673 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_AR_ENABLED, |
| erp_lite_bank_recon_enabled | navigation | config/navigation.ts | 705 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_BANK_RECON_ENABLED, |
| erp_lite_branch_pl_enabled | navigation | config/navigation.ts | 713 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_BRANCH_PL_ENABLED, |
...
| erp_lite_enabled | navigation | config/navigation.ts | 576 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 584 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 593 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 601 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 609 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 617 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 625 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 633 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 641 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 649 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_GL_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 657 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_GL_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 665 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 673 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_AR_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 681 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_AP_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 689 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_PO_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 697 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_EXPENSES_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 705 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_BANK_RECON_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 713 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_BRANCH_PL_ENABLED, |
| erp_lite_enabled | navigation | config/navigation.ts | 721 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED, |
| erp_lite_expenses_enabled | navigation | config/navigation.ts | 697 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_EXPENSES_ENABLED, |
| erp_lite_gl_enabled | navigation | config/navigation.ts | 649 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_GL_ENABLED, |
| erp_lite_gl_enabled | navigation | config/navigation.ts | 657 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_GL_ENABLED, |
| erp_lite_po_enabled | navigation | config/navigation.ts | 689 | featureFlag: FLAG_KEYS.ERP_LITE_ENABLED,//featureFlag: FLAG_KEYS.ERP_LITE_PO_ENABLED, |
