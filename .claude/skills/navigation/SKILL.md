---
name: navigation
description: navigation workflow for CleanMateX Tenant App. Use only when explicitly working on navigation-related tasks.
user-invocable: true
version: 1.1.0
deprecated: false
effort: medium
references:
  - @.claude/skills/navigation/reference-original.md
  - CLAUDE.md
agents:
---
...
Use this skill only when the task explicitly matches **navigation**. Keep the active prompt small; read `reference-original.md` only when deeper examples or edge cases are required.
