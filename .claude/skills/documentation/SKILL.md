---
name: documentation
description: documentation workflow for CleanMateX Tenant App. Use only when explicitly working on documentation-related tasks.
user-invocable: true
version: 1.1.0
deprecated: false
effort: low
references:
  - @.claude/skills/documentation/reference-original.md
  - CLAUDE.md
agents:
---
...
Use this skill only when the task explicitly matches **documentation**. Keep the active prompt small; read `reference-original.md` only when deeper examples or edge cases are required.
