...
If there is this in the data table:
Audit Record Fields UI: should be a Standard component such as Card or small popup window for this to be used in all the app
a small icon button to open this audit fields for the current record 
