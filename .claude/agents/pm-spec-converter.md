...
description: Use only when explicitly requested for scoped pm-spec-converter work. Avoid broad scans and nested agents.
version: 1.1.0
model: sonnet
---

# Pm Spec Converter Agent

## Role

Use this agent only when explicitly requested for scoped **pm-spec-converter** work.
...
```text
.claude/agent-references/pm-spec-converter-reference-original.md
```
