...
description: Use only when explicitly requested for scoped storybook-generator work. Avoid broad scans and nested agents.
version: 1.1.0
model: sonnet
---
...
Use this agent only when explicitly requested for scoped **storybook-generator** work.
...
```text
.claude/agent-references/storybook-generator-reference-original.md
```
