...
description: Use only when explicitly requested for scoped nav-refactor-specialist work. Avoid broad scans and nested agents.
version: 1.1.0
model: sonnet
---
...
Use this agent only when explicitly requested for scoped **nav-refactor-specialist** work.
...
```text
.claude/agent-references/nav-refactor-specialist-reference-original.md
```
