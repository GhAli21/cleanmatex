---
name: adr-producer
description: Use only when explicitly requested for scoped adr-producer work. Avoid broad scans and nested agents.
version: 1.1.0
model: sonnet
---
...
Use this agent only when explicitly requested for scoped **adr-producer** work.
...
```text
.claude/agent-references/adr-producer-reference-original.md
```
