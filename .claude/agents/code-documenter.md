...
description: Use only when explicitly requested for scoped code-documenter work. Avoid broad scans and nested agents.
version: 1.1.0
model: sonnet
---
...
Use this agent only when explicitly requested for scoped **code-documenter** work.
...
```text
.claude/agent-references/code-documenter-reference-original.md
```
