-- ================================================================
-- Migration: 0160 - Implement PLAN_CONSTRAINT and FEATURE_FLAG layers
-- ================================================================
-- Purpose: Add Layer 3 (PLAN_CONSTRAINT) and Layer 4 (FEATURE_FLAG)
--          to fn_stng_resolve_setting_value.
-- Layer 3: Apply plan-based constraints from sys_plan_setting_constraints
-- Layer 4: Check stng_depends_on_flags; if any disabled, force catalog default
...
'Resolves setting value using 7-layer hierarchy. Layers 3 (PLAN_CONSTRAINT) and 4 (FEATURE_FLAG) implemented in 0160.';
