    ...
    seed_lines AS (
      ...
      FROM (
        VALUES
          ...
          ('311000', '310000', 'EQUITY', 'EQUITY_CAPITAL', 'Capital Accounts', 'حسابات رأس المال', false, false, false, true, false, 152, NULL),
          ('311001', '311000', 'EQUITY', 'EQUITY_CAPITAL', 'Capital', 'رأس المال', true, false, true, true, false, 153, NULL),
          ('320000', '300000', 'EQUITY', 'EQUITY_RETAINED', 'Retained Earnings', 'الأرباح المبقاة', false, false, false, true, true, 153, NULL),
          ('321000', '320000', 'EQUITY', 'EQUITY_RETAINED', 'Retained Earnings Accounts', 'حسابات الأرباح المبقاة', false, false, false, true, false, 154, NULL),
          ('321001', '321000', 'EQUITY', 'EQUITY_RETAINED', 'Retained Earnings', 'الأرباح المبقاة', true, false, true, true, false, 155, NULL),
          ('330000', '300000', 'EQUITY', 'EQUITY_CYPL', 'Current Year Earnings', 'أرباح السنة الحالية', false, false, false, true, true, 155, NULL),
          ('331000', '330000', 'EQUITY', 'EQUITY_CYPL', 'Current Year Earnings Accounts', 'حسابات أرباح السنة الحالية', false, false, false, true, false, 156, NULL),
          ('331001', '331000', 'EQUITY', 'EQUITY_CYPL', 'Current Year Profit or Loss', 'ربح أو خسارة السنة الحالية', true, false, true, true, false, 157, NULL),
          ...
          ('421000', '420000', 'REVENUE', 'REV_OTHER', 'Other Revenue Accounts', 'حسابات الإيرادات الأخرى', false, false, false, true, false, 217, NULL),
          ('421001', '421000', 'REVENUE', 'REV_OTHER', 'Other Revenue', 'إيرادات أخرى', true, false, false, true, false, 218, NULL),
          ('421002', '421000', 'REVENUE', 'REV_OTHER', 'Discounts Recovered', 'استرداد خصومات', true, false, false, true, false, 219, NULL),
          ...
          ('531000', '530000', 'EXPENSE', 'EXP_ADMIN', 'Administrative Expense Accounts', 'حسابات المصروفات الإدارية', false, false, false, true, false, 272, NULL),
          ('531001', '531000', 'EXPENSE', 'EXP_ADMIN', 'Office Expense', 'مصروف المكتب', true, false, false, true, false, 273, NULL),
          ('531002', '531000', 'EXPENSE', 'EXP_ADMIN', 'Bank Charges', 'الرسوم البنكية', true, false, false, true, false, 274, NULL),
          ('531003', '531000', 'EXPENSE', 'EXP_ADMIN', 'Software Subscription Expense', 'مصروف اشتراك البرامج', true, false, false, true, false, 275, NULL),
          ('531004', '531000', 'EXPENSE', 'EXP_ADMIN', 'General Expense', 'مصروف عام', true, false, false, true, false, 276, 'EXPENSE_GENERAL'),
          ('531005', '531000', 'EXPENSE', 'EXP_ADMIN', 'Bad Debt Expense', 'مصروف ديون معدومة', true, false, false, true, false, 277, NULL),
          ('531006', '531000', 'EXPENSE', 'EXP_ADMIN', 'Petty Cash Expense', 'مصروف العهدة النقدية', true, false, false, true, false, 278, 'PETTY_CASH_EXPENSE'),
          ('540000', '500000', 'EXPENSE', 'EXP_OTHER', 'Other Expenses', 'مصروفات أخرى', false, false, false, true, true, 278, NULL),
          ('541000', '540000', 'EXPENSE', 'EXP_OTHER', 'Other Expense Accounts', 'حسابات المصروفات الأخرى', false, false, false, true, false, 279, NULL),
          ('541001', '541000', 'EXPENSE', 'EXP_OTHER', 'Loss on Adjustment', 'خسارة تسوية', true, false, false, true, false, 280, 'ROUNDING_ADJUSTMENT'),
          ('541002', '541000', 'EXPENSE', 'EXP_OTHER', 'Miscellaneous Expense', 'مصروفات متنوعة', true, false, false, true, false, 281, NULL)
...
JOIN (
  VALUES
    ...
    ('EXPENSE_GENERAL', '531004', false, 100),
    ('PETTY_CASH_EXPENSE', '531006', false, 110),
    ('ROUNDING_ADJUSTMENT', '541001', false, 120)
