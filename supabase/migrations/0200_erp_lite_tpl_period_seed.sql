...
VALUES
  ('ERP_LITE_SMALL_STD', 1, 'ERP-Lite Small Laundry Standard', 'القالب القياسي لمغسلة صغيرة', 'Published ERP-Lite baseline for small laundry tenants.', 'خط أساس منشور لـ ERP-Lite لمستأجري المغاسل الصغيرة.', 'ALL', 'SMALL_LAUNDRY', 'PUBLISHED', 'erp_lite_runtime_v1', CURRENT_DATE, CURRENT_TIMESTAMP, 'system_seed', CURRENT_TIMESTAMP, 'system_seed', 'system_seed', 'Migration 0200', 1, 10, true),
  ('ERP_LITE_MEDIUM_STD', 1, 'ERP-Lite Medium Dry Clean Standard', 'القالب القياسي لتنظيف جاف متوسط', 'Published ERP-Lite baseline for medium dry-clean tenants.', 'خط أساس منشور لـ ERP-Lite لمستأجري التنظيف الجاف المتوسط.', 'ALL', 'MEDIUM_DRY_CLEAN', 'PUBLISHED', 'erp_lite_runtime_v1', CURRENT_DATE, CURRENT_TIMESTAMP, 'system_seed', CURRENT_TIMESTAMP, 'system_seed', 'system_seed', 'Migration 0200', 1, 20, true),
  ('ERP_LITE_MINI_STD', 1, 'ERP-Lite Mini Shop Standard', 'القالب القياسي للمتجر الصغير', 'Published ERP-Lite baseline for mini-shop tenants.', 'خط أساس منشور لـ ERP-Lite لمستأجري المتاجر الصغيرة.', 'ALL', 'MINI_SHOP', 'PUBLISHED', 'erp_lite_runtime_v1', CURRENT_DATE, CURRENT_TIMESTAMP, 'system_seed', CURRENT_TIMESTAMP, 'system_seed', 'system_seed', 'Migration 0200', 1, 30, true),
  ('ERP_LITE_FULL_STD', 1, 'ERP-Lite Full Service Standard', 'القالب القياسي للخدمة الكاملة', 'Published ERP-Lite baseline for full-service laundry tenants.', 'خط أساس منشور لـ ERP-Lite لمستأجري الخدمة الكاملة.', 'ALL', 'FULL_SERVICE', 'PUBLISHED', 'erp_lite_runtime_v1', CURRENT_DATE, CURRENT_TIMESTAMP, 'system_seed', CURRENT_TIMESTAMP, 'system_seed', 'system_seed', 'Migration 0200', 1, 40, true),
  ('ERP_LITE_IND_STD', 1, 'ERP-Lite Industrial Standard', 'القالب القياسي للمغسلة الصناعية', 'Published ERP-Lite baseline for industrial laundry tenants.', 'خط أساس منشور لـ ERP-Lite لمستأجري المغاسل الصناعية.', 'ALL', 'INDUSTRIAL', 'PUBLISHED', 'erp_lite_runtime_v1', CURRENT_DATE, CURRENT_TIMESTAMP, 'system_seed', CURRENT_TIMESTAMP, 'system_seed', 'system_seed', 'Migration 0200', 1, 50, true),
  ('ERP_LITE_GLOBAL_STD', 1, 'ERP-Lite Global Fallback', 'القالب الاحتياطي العالمي لـ ERP-Lite', 'Published ERP-Lite fallback used when tenant business type is missing or unmatched.', 'قالب احتياطي منشور لـ ERP-Lite يُستخدم عندما يكون نوع العمل للمستأجر مفقوداً أو غير مطابق.', 'ALL', NULL, 'PUBLISHED', 'erp_lite_runtime_v1', CURRENT_DATE, CURRENT_TIMESTAMP, 'system_seed', CURRENT_TIMESTAMP, 'system_seed', 'system_seed', 'Migration 0200', 1, 90, true)
