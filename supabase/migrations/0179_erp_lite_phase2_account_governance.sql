...
FROM (
  VALUES
    ('ASSET_CURRENT', 'ASSET', 'Current Assets', 'الأصول المتداولة', 'Asset group for current operational assets.', 'مجموعة أصول للأصول التشغيلية المتداولة.', 10),
    ('ASSET_RECEIVABLE', 'ASSET', 'Receivables', 'الذمم المدينة', 'Asset group for receivable control accounts.', 'مجموعة أصول لحسابات الذمم المدينة.', 20),
    ('ASSET_CASH_BANK', 'ASSET', 'Cash and Bank', 'النقد والبنك', 'Asset group for cash, petty cash, and bank clearing accounts.', 'مجموعة أصول للنقد والعهدة والبنك.', 30),
    ('ASSET_TAX_INPUT', 'ASSET', 'Recoverable Input Tax', 'ضريبة مدخلات قابلة للاسترداد', 'Asset group for recoverable input VAT accounts.', 'مجموعة أصول لحسابات ضريبة المدخلات القابلة للاسترداد.', 40),
    ('LIAB_CURRENT', 'LIABILITY', 'Current Liabilities', 'الالتزامات المتداولة', 'Liability group for short-term obligations.', 'مجموعة التزامات للالتزامات قصيرة الأجل.', 50),
    ('LIAB_TAX_OUTPUT', 'LIABILITY', 'Output Tax Payable', 'ضريبة مخرجات مستحقة', 'Liability group for output VAT payable accounts.', 'مجموعة التزامات لحسابات ضريبة المخرجات المستحقة.', 60),
    ('REV_OPERATING', 'REVENUE', 'Operating Revenue', 'الإيرادات التشغيلية', 'Revenue group for core laundry service revenue.', 'مجموعة إيرادات للإيرادات التشغيلية الأساسية.', 70),
    ('EXP_OPERATING', 'EXPENSE', 'Operating Expenses', 'المصروفات التشغيلية', 'Expense group for operating costs and petty cash expenses.', 'مجموعة مصروفات للمصروفات التشغيلية ومصروفات العهدة النقدية.', 80)
) AS seed(acc_group_code, acc_type_code, name, name2, description, description2, rec_order)
